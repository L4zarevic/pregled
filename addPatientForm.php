            ...
            <div class='generalije1'>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <textarea name="napomena_pacijenta" placeholder="Unesite napomenu vezanu za klijenta" class="form-control" type="text" title="Unesite napomenu vezanu za klijenta" id="napomena_pacijenta" row="4"></textarea>
                </div>
              </div>
            </div>
