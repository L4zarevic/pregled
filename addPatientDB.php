...
$upit = "INSERT INTO pacijenti (IDKorisnika,generalije_pacijenta,kontakt,napomena,naocare_blizina_od,naocare_blizina_os,naocare_daljina_od,naocare_daljina_os,sociva_od,sociva_os) VALUES ('$idKorisnika','$generalije_pacijenta','$kontaktPacijenta','$napomenaPacijenta','$naocare_blizina_od','$naocare_blizina_os','$naocare_daljina_od','$naocare_daljina_os','$sociva_od','$sociva_os')";
