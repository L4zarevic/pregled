...
if (isset($_POST['search'])) {
   ...
   $Name = $_POST['search'];
   //Search query.
   $Query = "SELECT ID,generalije_pacijenta,kontakt,napomena,naocare_daljina_od,naocare_daljina_os,naocare_blizina_od,naocare_blizina_os,sociva_od,sociva_os FROM pacijenti WHERE generalije_pacijenta LIKE '%$Name%'";
   //Query execution
