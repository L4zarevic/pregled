...
$stmt->bind_param('iiisssssssssssssssss', $id_pacijenta, $id_korisnika, $broj_radnog_naloga, $datum, $desno_d_sph, $desno_d_cyl, $desno_d_ax, $desno_b_sph, $desno_b_cyl, $desno_b_ax, $lijevo_d_sph, $lijevo_d_cyl, $lijevo_d_ax, $lijevo_b_sph, $lijevo_b_cyl, $lijevo_b_ax, $pd_blizina, $pd_daljina, $napomena1, $napomena2);
$stmt->execute();
