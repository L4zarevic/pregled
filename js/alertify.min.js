...
function updatePatientCheckForm(){
	...
	if ((generalije.length == 0)){
		alertify.error('Greška!',"Polje sa generalijama pacijenta ne može biti prazno!");
...
function checkFormExamination() {
	  ...
	  var success = ime_prezime_pacijenta + '@@@' + datum_pregleda + '@@@' + anamneza + '@@@' + vod + '@@@' + vos + '@@@' + motilitet + '@@@' + bms_od + '@@@' + bms_os + '@@@' + tonus_od + '@@@' + tonus_os + '@@@' + fundus_od + '@@@' + fundus_os + '@@@' + dijagnoza + '@@@' + terapija + '@@@' + kontrola + '@@@'+ korekcija_daljina_od + '@@@' + korekcija_daljina_os + '@@@' + korekcija_blizina_od + '@@@' + korekcija_blizina_os + '@@@' + pd + '@@@' + tip_ks_od + '@@@' + jacina_ks_od + '@@@' + bc_ks_od + '@@@' + velicina_ks_od + '@@@' + boja_ks_od + '@@@' + tip_ks_os + '@@@' + jacina_ks_os + '@@@' + bc_ks_os + '@@@' + velicina_ks_os + '@@@' + boja_ks_os + '@@@' + napomena_pregleda;
