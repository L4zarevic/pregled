...
function checkLensesFormExamination(){
      ...
      $.ajax({
        ...
        error: function() {
		  window.location.href = "../pregled/examinationLensesReport.php?success="+success;
        }
      });
...
function checkFormExamination() {
	 ...
	 var success = radnik + '@@@'+ ime_prezime_pacijenta + '@@@' + datum_pregleda + '@@@' + anamneza.replace(/\+/g,'%2B ') + '@@@' + vod.replace(/\+/g,'%2B ') + '@@@' + vos.replace(/\+/g,'%2B ') + '@@@' + motilitet.replace(/\+/g,'%2B ') + '@@@' + bms_od.replace(/\+/g,'%2B ') + '@@@' + bms_os.replace(/\+/g,'%2B ') + '@@@' + tonus_od.replace(/\+/g,'%2B ') + '@@@' + tonus_os.replace(/\+/g,'%2B ') + '@@@' + fundus_od.replace(/\+/g,'%2B ') + '@@@' + fundus_os.replace(/\+/g,'%2B ') + '@@@' + dijagnoza.replace(/\+/g,'%2B ') + '@@@' + terapija.replace(/\+/g,'%2B ') +'@@@'+ korekcija_daljina_od.replace(/\+/g,'%2B ') + '@@@' + korekcija_daljina_os.replace(/\+/g,'%2B ') + '@@@' + korekcija_blizina_od.replace(/\+/g,'%2B ') + '@@@' + korekcija_blizina_os.replace(/\+/g,'%2B ') + '@@@' + pd + '@@@' + kontrola.replace(/\+/g,'%2B ') + '@@@'+napomena_pregleda.replace(/\+/g,'%2B ');
