...
function checkFormExamination() {
	  ...
	  var success = ime_prezime_pacijenta + '@@@' + datum_pregleda + '@@@' + anamneza + '@@@' + vod + '@@@' + vos + '@@@' + motilitet + '@@@' + bms_od + '@@@' + bms_os + '@@@' + tonus_od + '@@@' + tonus_os + '@@@' + fundus_od + '@@@' + fundus_os + '@@@' + dijagnoza + '@@@' + terapija + '@@@' + korekcija_od + '@@@' + korekcija_os + '@@@' + tip_ks_od + '@@@' + jacina_ks_od + '@@@' + bc_ks_od + '@@@' + velicina_ks_od + '@@@' + boja_ks_od + '@@@' + tip_ks_os + '@@@' + jacina_ks_os + '@@@' + bc_ks_os + '@@@' + velicina_ks_os + '@@@' + boja_ks_os + '@@@' + pd + '@@@' + kontrola + '@@@' + napomena_pregleda;
