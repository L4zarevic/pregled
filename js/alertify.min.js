...
function checkFormExamination() {
      ...
      vod = document.getElementById("vod").value;
      ...
      dijagnoza_od = document.getElementById("dijagnoza_od").value;
      dijagnoza_os = document.getElementById("dijagnoza_os").value;
	  terapija = document.getElementById("terapija").value;
      korekcija_od = document.getElementById("korekcija_od").value;
      korekcija_os = document.getElementById("korekcija_os").value;
	  ...
	  var success = ime_prezime_pacijenta + '@@@' + datum_pregleda + '@@@' + anamneza + '@@@' + vod + '@@@' + vos + '@@@' + motilitet + '@@@' + bms_od + '@@@' + bms_os + '@@@' + tonus_od + '@@@' + tonus_os + '@@@' + fundus_od + '@@@' + fundus_os + '@@@' + dijagnoza_od + '@@@' + dijagnoza_os + '@@@' + terapija + '@@@' + korekcija_od + '@@@' + korekcija_os + '@@@' + tip_ks_od + '@@@' + jacina_ks_od + '@@@' + bc_ks_od + '@@@' + velicina_ks_od + '@@@' + boja_ks_od + '@@@' + tip_ks_os + '@@@' + jacina_ks_os + '@@@' + bc_ks_os + '@@@' + velicina_ks_os + '@@@' + boja_ks_os + '@@@' + pd + '@@@' + kontrola + '@@@' + napomena_pregleda;
      ...
      $.ajax({
        ...
        data: ({
          ...
          fundus_od: fundus_od,
          fundus_os: fundus_os,
          dijagnoza_od: dijagnoza_od,
          dijagnoza_os: dijagnoza_os,
		  terapija: terapija,
          korekcija_od: korekcija_od,
          korekcija_os: korekcija_os,
          tip_ks_od: tip_ks_od,
