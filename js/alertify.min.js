...
function addPatientCheckForm() {
	...
	if ((ime_pacijenta.length == 0) || (ime_oca_pacijenta.length == 0) || (prezime_pacijenta.length == 0) || (godiste_pacijenta.length == 0)){
		alertify.alert('Niste unijeli sve podatke!',"Obavezna polja za unos su: Ime; Ime oca; Prezime; Godina rođenja");
        return false;
	}
		$.ajax({
          type: 'POST',
...
function updatePatientCheckForm(){
	...
	generalije = document.getElementById('patientGeneralsRecords').value;
...
function checkFormExamination() {
	  ...
	  id_radnika = document.getElementById("id_radnika").value;
