...
function checkWorkOrderDocument() {
    ...
    napomena1 = document.getElementById("napomena1").value;
	napomena2 = document.getElementById("napomena2").value;
	...
	if (napomena1.length == 0) {
        document.getElementById("napomena1").focus();
        alertify.alert('Informacija', "Niste unijeli napomenu ");
        return false;
    }
	
	if (napomena2.length == 0) {
        document.getElementById("napomena2").focus();
        alertify.alert('Informacija', "Niste unijeli podatke o saldu ");
        return false;
    }
