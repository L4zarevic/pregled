...
function checkFormExamination() {
 ...
 function checkUser(sifra, id_pregleda) {
	...
	function updateFormExamination(id_pregleda) {
	  ...
	  if(pd.length == 0){
		  document.getElementById("inputPdReport").focus();
		  alertify.alert('Informacija',"Polje sa podacima o pupilarnoj distanci (PD) ne može biti prazno!");
		  return false;
	  }
      ...
      $.ajax({
        ...
        error: function() {
			alertify.success('Izvještaj pregleda je uspiješno ažuriran');
		 // window.location.href = "../pregled/examinationReport.php?success="+success;
        }
      });
