...
$upit = "SELECT * FROM pregledi WHERE ID=$id_pregleda";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class='tabelaSpecijala1'>
                        ...
                        echo " <div class='row'> <strong><label>Pregled urađen u: </label></strong> &nbsp; $radnik</div>";
                        ...
                        echo "<div class='row'><div class='form-group col-md-6'> <label>VOD:</label> &nbsp;<input name='vod' title='' type='text' class='form-control' id='' value='$vod'> </div></div>";
                        echo "<div class='row'> <div class='form-group col-md-6'><label>VOS:</label> &nbsp; <input name='vod' title='' type='text' class='form-control' id='' value='$vos'></div></div>";
                        echo "<hr>";
                        echo "<div class='motelitetTonusGrupa'>";
                        echo "<div class='motilitetGrupa'>";
                        echo "<div class='row'><div class='form-group col-md-6'> <strong><label>MOTILITET: </label></strong> &nbsp; <input name='motilitet' title='' type='text' class='form-control' id='' value='$motilitet'></div></div>";
                        echo "</div>";
                        echo "<div class='tonusGrupa'>";
                        echo "<div class='row'> <strong><label>TONUS: </label></strong></div>";
                        echo "<div class='row'><div class='form-group col-md-4'> <label>OD: </label></strong> &nbsp;  <input name='' title='' type='text' class='form-control' id='' value='$tonus_od'></div></div>";
                        echo "<div class='row'> <div class='form-group col-md-4'><label>OS: </label></strong> &nbsp; <input name='' title='' type='text' class='form-control' id='' value='$tonus_os'></div></div>";
                        echo "</div>";
                        echo "</div>";
                        echo "<br>";
                        echo "<div id='grupa1'>";
